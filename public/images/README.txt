...
This means all the styles are contained in a single file:
  PlaywriteAUTAS-VariableFont_wght.ttf

If your app fully supports variable fonts, you can now pick intermediate styles
that aren’t available as static fonts. Not all apps support variable fonts, and
in those cases you can use the static font files for Playwrite AU TAS:
  static/PlaywriteAUTAS-Thin.ttf
  static/PlaywriteAUTAS-ExtraLight.ttf
  static/PlaywriteAUTAS-Light.ttf
  static/PlaywriteAUTAS-Regular.ttf
