...
const AboutMe = () => {
    return (
        <div id='about' className='px-4 text-[#313131] md:px-[5%] lg:px-[10%] xl:px-[15%] w-full bg-[#c4c4c4] gap-x-3 min-h-screen flex items-center justify-center py-[10%] lg:flex-row gap-y-2 flex-col'>
            ...
            <div className='flex-1'>
                ...
                <p className='text-2xl font-outfit '>
                    Hi, my name is <span className='font-play duration-150 text-[#313131] font-semibold '>Sayeed</span>. I started out as a web designer in
                    <span className='font-play  font-semibold  text-[#313131]'> 2022</span>. However, over the past year I’ve been diving into web
