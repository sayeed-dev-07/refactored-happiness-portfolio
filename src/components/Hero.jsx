...
const Hero = () => {
    return (
        <div id='hero' className='min-h-[90vh] flex items-center justify-center xl:justify-start text-white px-4 md:px-[5%] lg:px-[10%] xl:px-[15%]'>
            <div 
                className={`xl:w-[70%] group sm:relative w-full bg-center bg-cover sm:bg-contain bg-no-repeat  min-h-[50vh]  bg-[url('/images/hero-mini.png')] sm:bg-[url('/images/hero.png')] py-[15%]  xl:py-[10%] justify-self-center`}>
                    <div className='sm:absolute  flex flex-col py-[15%] px-[8%] sm:py-0 sm:px-0 gap-y-6 top-[40%] left-[5%] sm:left-[10%] z-10 font-bungee text-[#313131]'>
