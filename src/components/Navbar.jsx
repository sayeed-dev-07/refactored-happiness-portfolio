    ...
    return (
        <>
            <div className='flex font-outfit px-4 md:px-[5%] lg:px-[10%] xl:px-[15%]  bg-[#c4c4c4] flex-col relative'>
                <div className='text-[#313131]  py-6 flex items-center justify-between gap-x-6'>
                ...
                <div className='text-2xl md:flex hidden items-center tex-[#631e14] justify-center gap-12 '>
                    <a className='flex flex-col group gap-y-1' href="#hero"><p>Home</p>
                        <div className='group-hover:w-full  transition-all duration-150 w-0 bg-[#332c2b] h-[0.1rem]'></div>
                    </a>
                    <a className='flex flex-col group gap-y-1' href="#project"><p>Project</p>
                        <div className='group-hover:w-full  transition-all duration-150 w-0 bg-[#332c2b] h-[0.1rem]'></div>
                    </a>
                    <a className='flex flex-col group gap-y-1' href="#about"><p>About</p>
                        <div className='group-hover:w-full  transition-all duration-150 w-0 bg-[#332c2b] h-[0.1rem]'></div>
                    </a>
                    <a className='flex flex-col group gap-y-1' href="#contact"><p>Contact</p>
                        <div className='group-hover:w-full  transition-all duration-150 w-0 bg-[#332c2b] h-[0.1rem]'></div>
                    </a>
                </div>

            </div> 
            <div className={`fixed top-[10%] text-center left-0 z-20 h-screen w-full bg-[#000000ea] text-white flex flex-col items-center justify-center md:hidden transform transition-transform duration-300 ease-in-out ${hamburgerOn ? 'translate-x-0' : 'translate-x-full'}`}>
                <a onClick={()=> setHambargerOn(false)} className='w-full  text-3xl py-4 ' href="#hero">Home</a>
                <a onClick={()=> setHambargerOn(false)} className='w-full  text-3xl py-4 ' href="#about">About</a>
                <a onClick={()=> setHambargerOn(false)} className='w-full text-3xl py-4' href="#project">Project</a>
                <a onClick={()=> setHambargerOn(false)} className='w-full text-3xl py-4' href="#contact">Contact</a>
            </div>
            </div>
